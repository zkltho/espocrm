...
_delimiter_rf7qbkzu0pk
res/templates/modals/resolve-save-conflict.tpl
...
{{#if idValue}}
{{{avatar}}}
<a href="#{{foreignScope}}/view/{{idValue}}" title="{{nameValue}}" class="text-default">{{nameValue}}</a>
{{/if}}
...
_delimiter_rf7qbkzu0pk
res/templates/fields/datetime-short/list.tpl
{{#if dateValue~}}
    <span
        title="{{fullDateValue}}"
...
_delimiter_rf7qbkzu0pk
res/templates/fields/datetime-short/detail.tpl
{{#if dateValue ~}}
    <span
        title="{{fullDateValue}}"
        {{#if style}}class="text-{{style}}"{{/if}}
...
<div class="input-group">
    <input class="main-element form-control" type="text" data-name="{{name}}" value="{{dateValue}}" autocomplete="espo-{{name}}">
    <span class="input-group-btn">
        <button type="button" class="btn btn-default btn-icon date-picker-btn" tabindex="-1"><i class="far fa-calendar"></i></button>
    </span>
</div>
...
_delimiter_rf7qbkzu0pk
res/templates/dashlets/fields/records/expanded-layout/edit.tpl
...
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/opportunity/admin/field-manager/fields/probability-map/edit.tpl
...
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/mass-email/modals/send-test.tpl
<div class="row">
...
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/campaign/tracking-url.tpl
<div class="container content">
    <div class="block-center-md">
        <div class="panel panel-default">
            <div class="panel-body">
...
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/calendar/record/shared-options.tpl
<div class="cell" data-name="users">
    <label class="control-label" data-name="users">{{{translate 'User List' scope='Calendar'}}}</label>
    <div class="field" data-name="users">{{{usersField}}}</div>
</div>
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/calendar/record/edit-view.tpl
<div class="row">
...
_delimiter_rf7qbkzu0pk
modules/crm/res/templates/calendar/modals/shared-options.tpl
<div class="panel panel-default no-side-margin">
<div class="panel-body">
