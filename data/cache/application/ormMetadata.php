...
return [
  ...
  'Settings' => [
    ...
    'attributes' => [
      ...
      'CustomLoginBackgroundName' => [
        'type' => 'foreign',
        'relation' => 'CustomLoginBackground',
        'foreign' => 'name',
        'foreignType' => 'varchar'
      ],
      'CustomLoginPortalBackgroundId' => [
        'len' => 17,
        'dbType' => 'string',
        'type' => 'foreignId',
        'index' => false,
      ...
      'CustomLoginPortalBackgroundName' => [
        'type' => 'foreign',
        'relation' => 'CustomLoginPortalBackground',
        'foreign' => 'name',
        'foreignType' => 'varchar'
      ]
    ],
    'relations' => [
      ...
      'CustomLoginPortalBackground' => [
        'type' => 'belongsTo',
        'entity' => 'Attachment',
        'key' => 'CustomLoginPortalBackgroundId',
        'foreignKey' => 'id',
        'foreign' => NULL
      ]
    ],
